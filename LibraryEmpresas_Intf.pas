...
type
  ...
  private
    ...
    fUsuario: Integer;
    function GetEjercicioFin: TCarteraVale;
  protected
    property int_EjercicioFin: TCarteraVale read fEjercicioFin;
  public
  ...
  published
    ...
    property EjercicioFin:TCarteraVale read GetEjercicioFin write fEjercicioFin;
...
begin
  ...
  if (iSource is LibraryEmpresas_Intf.TParametros) then begin
    ...
    if System.Assigned(lSource.fEjercicioFin) then
      Self.EjercicioFin.Assign(lSource.fEjercicioFin)
    else
      SysUtils.FreeAndNil(fEjercicioFin);
...
function TParametros.GetEjercicioFin: TCarteraVale;
begin
  if (fEjercicioFin = nil) then fEjercicioFin := TCarteraVale.Create();
  Result := fEjercicioFin;
end;
...
begin
  if TROSerializer(ASerializer).RecordStrictOrder then begin
    ...
    Self.Dia := l_Dia;
    l_EjercicioFin := int_EjercicioFin;
    try
      TROSerializer(ASerializer).ReadStruct('EjercicioFin', TCarteraVale, l_EjercicioFin);
    except
      on E: SysUtils.Exception do
    ...
    if int_EjercicioFin <> l_EjercicioFin then Self.EjercicioFin.Free;
    ...
    if int_EjercicioFin <> l_EjercicioFin then EjercicioFin.Free;
    Self.EjercicioFin := l_EjercicioFin;
    l_EmpleadoFin := Self.EmpleadoFin;
    try
      TROSerializer(ASerializer).ReadInteger('EmpleadoFin', TypInfo.otSLong, l_EmpleadoFin);
...
begin
  if TROSerializer(ASerializer).RecordStrictOrder then begin
    ...
    l_EjercicioFin := int_EjercicioFin;
    TROSerializer(ASerializer).WriteStruct('EjercicioFin', l_EjercicioFin, TCarteraVale);
    l_PeriodoFin := Self.PeriodoFin;
...
function TServiceEmpresas_Proxy.obtendatosfotosnombresempleados(const Nombres: AnsiString): AnsiString;
var
  lMessage: IROMessage;
  lTransportChannel: IROTransportChannel;
begin
  ...
  lTransportChannel := __TransportChannel;
  try
    lMessage.InitializeRequestMessage(lTransportChannel, 'LibraryEmpresas', __InterfaceName, 'obtendatosfotosnombresempleados');
    lMessage.Write('Nombres', System.TypeInfo(AnsiString), Nombres, []);
    lMessage.Finalize;
...
function TServiceEmpresas_Proxy.obtenRostros10(const idemp: AnsiString): AnsiString;
var
  lMessage: IROMessage;
  lTransportChannel: IROTransportChannel;
begin
  ...
  lTransportChannel := __TransportChannel;
  try
    lMessage.InitializeRequestMessage(lTransportChannel, 'LibraryEmpresas', __InterfaceName, 'obtenRostros10');
    lMessage.Write('idemp', System.TypeInfo(AnsiString), idemp, []);
    lMessage.Finalize;
...
function TServiceEmpresas_Proxy.obtenIDEmpleado: Integer;
var
  lMessage: IROMessage;
  lTransportChannel: IROTransportChannel;
begin
  ...
  lTransportChannel := __TransportChannel;
  try
    lMessage.InitializeRequestMessage(lTransportChannel, 'LibraryEmpresas', __InterfaceName, 'obtenIDEmpleado');
    lMessage.Finalize;
...
function TServiceEmpresas_Proxy.obtenListaSyncronizado(const listado1: AnsiString; const listado2: AnsiString): AnsiString;
var
  lMessage: IROMessage;
  lTransportChannel: IROTransportChannel;
begin
  ...
  lTransportChannel := __TransportChannel;
  try
    lMessage.InitializeRequestMessage(lTransportChannel, 'LibraryEmpresas', __InterfaceName, 'obtenListaSyncronizado');
    lMessage.Write('listado1', System.TypeInfo(AnsiString), listado1, []);
    lMessage.Write('listado2', System.TypeInfo(AnsiString), listado2, []);
    lMessage.Finalize;
