...
type
  ...
  firmabase64,fotobase64: AnsiString): AnsiString; stdcall;
    ...
    function obtenListaSyncronizado(listadosyncronizar1, listadosyncronizar2: AnsiString): AnsiString; stdcall;
  end;
...
function Tandroidservice.obtenListaSyncronizado(
  listadosyncronizar1, listadosyncronizar2: AnsiString): AnsiString;
begin
  result:= DM.Servidor.obtenListaSyncronizado(listadosyncronizar1, listadosyncronizar2);
end;
